#----------------------------------------------------------
# TreeSprouting.R: Functions required to sprout the Network Causal Tree
#------------------------------------------------------------------
...
#' @return A data frame reporting the results of the Network Causal Trees. #' Specifically the OF variable includes the value of the OF in the corresponding partition, the NOBS_TR column
