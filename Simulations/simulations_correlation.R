...
avg_tau_1000_1 <-  avg_tau_1000_2 <- c()
for(i in seq){
  avg_tau_1000_1[which(seq==i)] <- mean( tau_est_1000[,which(seq==i)][tau_est_1000[,which(seq==i)]>= mean(tau_est_1000[,which(seq==i)], na.rm = TRUE)] , na.rm = TRUE )
  avg_tau_1000_2[which(seq==i)] <- mean( tau_est_1000[,which(seq==i)][tau_est_1000[,which(seq==i)]<= mean(tau_est_1000[,which(seq==i)], na.rm = TRUE)] , na.rm = TRUE )
}

avg_se_1000_1 <-  avg_se_1000_2 <- c()
for(i in seq){
  avg_se_1000_1[which(seq==i)] <- mean( se_tau_est_1000[,which(seq==i)][tau_est_1000[,which(seq==i)]>=  mean(tau_est_1000[,which(seq==i)], na.rm = TRUE)] , na.rm = TRUE )
  avg_se_1000_2[which(seq==i)] <- mean( se_tau_est_1000[,which(seq==i)][tau_est_1000[,which(seq==i)]<=  mean(tau_est_1000[,which(seq==i)], na.rm = TRUE)] , na.rm = TRUE )
}

avg_eta_0100_1 <-  avg_eta_0100_2 <- c()
for(i in seq){
  avg_eta_0100_1[which(seq==i)] <- mean( eta_est_0100[,which(seq==i)][eta_est_0100[,which(seq==i)]>= mean(eta_est_0100[,which(seq==i)], na.rm = TRUE)] , na.rm = TRUE )
  avg_eta_0100_2[which(seq==i)] <- mean( eta_est_0100[,which(seq==i)][eta_est_0100[,which(seq==i)]<= mean(eta_est_0100[,which(seq==i)], na.rm = TRUE)] , na.rm = TRUE )
}

avg_se_0100_1 <-  avg_se_0100_2 <- c()
for(i in seq){
  avg_se_0100_1[which(seq==i)] <- mean( se_eta_est_0100[,which(seq==i)][eta_est_0100[,which(seq==i)]>=  mean(eta_est_0100[,which(seq==i)], na.rm = TRUE)] , na.rm = TRUE )
  avg_se_0100_2[which(seq==i)] <- mean( se_eta_est_0100[,which(seq==i)][eta_est_0100[,which(seq==i)]<=  mean(eta_est_0100[,which(seq==i)], na.rm = TRUE)] , na.rm = TRUE )
}
...
for(i in seq){
  mse_tau_est_1000[which(seq==i)] <- mean( (abs(tau_est_1000[,which(seq==i)][tau_est_1000[,which(seq==i)]<= mean(tau_est_1000[,which(seq==i)], na.rm = TRUE)]) - i)^2 , na.rm = TRUE )
  bias_tau_est_1000[which(seq==i)] <- mean( (abs(tau_est_1000[,which(seq==i)][tau_est_1000[,which(seq==i)]<= mean(tau_est_1000[,which(seq==i)], na.rm = TRUE)]) - i) , na.rm = TRUE )
  mse_eta_est_0100[which(seq==i)] <- mean( (abs(eta_est_0100[,which(seq==i)][eta_est_0100[,which(seq==i)]>= mean(eta_est_0100[,which(seq==i)], na.rm = TRUE)]) - i)^2 , na.rm = TRUE )
  bias_eta_est_0100[which(seq==i)] <- mean( (abs(eta_est_0100[,which(seq==i)][eta_est_0100[,which(seq==i)]>= mean(eta_est_0100[,which(seq==i)], na.rm = TRUE)]) - i) , na.rm = TRUE )
}
...
colnames(results_nctree) <- c("correct_rules",
                              ...
                              "Coverage eta(01,00)",
                              "VI x1", "VI x2", "VI X")
write.csv(results_nctree, file = "two_main_spillover_effects_composite_3000.csv")
...
colnames(results_nctree) <- c("correct_rules_main",
                              ...
                              "Rule 2 se(eta(01,00))",
                              "Coverage eta(01,00)") # , "VI x1", "VI x2", "VI X"
write.csv(results_nctree, file = "two_main_spillover_effects_singular_main_3000.csv")
...
colnames(results_nctree) <- c("correct_rules_spil",
                              ...
                              "Rule 2 se(eta(01,00))",
                              "Coverage eta(01,00)") #,"VI x1", "VI x2", "VI X"
write.csv(results_nctree, file = "two_main_spillover_effects_singular_spillover_3000.csv")
