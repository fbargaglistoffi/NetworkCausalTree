...
#      coverage_est_1000[j,which(seq==i)] <- between(i, abs(tau_est_1000[j,which(seq==i)][tau_est_1000[j,which(seq==i)]<= mean(tau_est_1000[j,which(seq==i)], na.rm = TRUE)]) - 1.96*se_tau_est_1000[j,which(seq==i)][tau_est_1000[j,which(seq==i)]<= mean(tau_est_1000[j,which(seq==i)], na.rm = TRUE)],
#                                                    abs(tau_est_1000[j,which(seq==i)][tau_est_1000[j,which(seq==i)]<= mean(tau_est_1000[j,which(seq==i)], na.rm = TRUE)]) + 1.96*se_tau_est_1000[j,which(seq==i)][tau_est_1000[j,which(seq==i)]<= mean(tau_est_1000[j,which(seq==i)], na.rm = TRUE)])
#    }
#    else {
