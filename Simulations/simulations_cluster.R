...
system.time({
  matrix <- foreach(j = 1:nsim,  .combine = 'comb', .multicombine = TRUE) %dopar% {
    ...
    for (i in seq)   {
      ...
      if (correct==2){ 
        # tau1000_1 & tau1101_1 & tau1000_1 & tau_1101_2
        effects.test1000_1 <- SNCT$EFF1000_TEST[which(SNCT$RULE.NUM==1)]
        effects.test1000_2 <- SNCT$EFF1000_TEST[which(SNCT$RULE.NUM==2)] 
        se.test1000_1 <- SNCT$SE1000_TEST[which(SNCT$RULE.NUM==1)]
        se.test1000_2 <- SNCT$SE1000_TEST[which(SNCT$RULE.NUM==2)] 
      }  
      ...
      rm(w, g, y, M, X, x1, x2, x3, x4, x5, x6, x7, x8, x9, x10,
         ...
         effects.test1000_1, effects.test1000_2,
         se.est1000_1, se.est1000_2,
         se.test1000_1, se.test1000_2)
    }
  ...
  matrix <- foreach(j = 1:nsim,  .combine = 'comb', .multicombine = TRUE) %dopar% {
    ...
    for (i in seq)   {
      ...
      if (correct==2){ 
        ...
        effects.test1000_1 <- SNCT$EFF1000_TEST[which(SNCT$RULE.NUM==1)]
        effects.test1000_2 <- SNCT$EFF1000_TEST[which(SNCT$RULE.NUM==2)] 
        effects.test1101_1 <- SNCT$EFF1101_TEST[which(SNCT$RULE.NUM==1)] 
        effects.test1101_2 <- SNCT$EFF1101_TEST[which(SNCT$RULE.NUM==2)] 
        se.test1000_1 <- SNCT$SE1000_TEST[which(SNCT$RULE.NUM==1)]
        se.test1000_2 <- SNCT$SE1000_TEST[which(SNCT$RULE.NUM==2)] 
        se.test1101_1 <- SNCT$SE1101_TEST[which(SNCT$RULE.NUM==1)] 
        se.test1101_2 <- SNCT$SE1101_TEST[which(SNCT$RULE.NUM==2)] 
      }  
      ...
      rm(w, g, y, M, X, x1, x2, x3, x4, x5, x6, x7, x8, x9, x10,
         ...
         effects.test1000_1, effects.test1000_2,
         effects.test1101_1, effects.test1101_2,
         se.est1000_1, se.est1000_2,
         se.est1101_1, se.est1101_2,
         se.test1000_1, se.test1000_2,
         se.test1101_1, se.test1101_2)
    }
...
coverage_test_1101 <- colMeans(coverage_test_1101, na.rm = TRUE) 
...
colnames(nctree) <- c("correct_rules",
                      ...
                      "vi_x1", "vi_x2", "vi_X")
write.csv(nctree, file = "two_main_effects_1500.csv")
...
system.time({
  matrix <- foreach(j = 1:nsim,  .combine = 'comb', .multicombine = TRUE) %dopar% {
    ...
    eta.test.1110 <- data.frame()
    eta.test.0100 <- data.frame()
    se.eta.est.1110 <- data.frame()
    se.eta.est.0100 <- data.frame()
    se.eta.test.1110 <- data.frame()
    se.eta.test.0100 <- data.frame()
    vi.x1 <- vi.x2 <- vi.X <- data.frame()
    ...
    for (i in seq)   {
      ...
      if (correct==2){ 
        # eta1110_1 & eta0100_1 & eta1110_1 & eta_0100_2
        effects.test1110_1 <- SNCT$EFF1110_TEST[which(SNCT$RULE.NUM==1)]
        effects.test1110_2 <- SNCT$EFF1110_TEST[which(SNCT$RULE.NUM==2)] 
        effects.test0100_1 <- SNCT$EFF0100_TEST[which(SNCT$RULE.NUM==1)] 
        effects.test0100_2 <- SNCT$EFF0100_TEST[which(SNCT$RULE.NUM==2)] 
        se.test1110_1 <- SNCT$SE1110_TEST[which(SNCT$RULE.NUM==1)]
        se.test1110_2 <- SNCT$SE1110_TEST[which(SNCT$RULE.NUM==2)] 
        se.test0100_1 <- SNCT$SE0100_TEST[which(SNCT$RULE.NUM==1)] 
        se.test0100_2 <- SNCT$SE0100_TEST[which(SNCT$RULE.NUM==2)] 
      }  
      ...
      rm(w, g, y, M, X, x1, x2, x3, x4, x5, x6, x7, x8, x9, x10,
         ...
         effects.test1110_1, effects.test1110_2,
         effects.test0100_1, effects.test0100_2,
         se.est1110_1, se.est1110_2,
         se.est0100_1, se.est0100_2,
         se.test1110_1, se.test1110_2,
         se.test0100_1, se.test0100_2)
    }
...
coverage_test_0100 <- colMeans(coverage_test_0100, na.rm = TRUE)
...
colnames(nctree) <- c("correct_rules",
                      ...
                      "vi_x1", "vi_x2", "vi_X")
write.csv(nctree, file = "two_spillover_effects_1500.csv")
  ...
  matrix <- foreach(j = 1:nsim,  .combine = 'comb', .multicombine = TRUE) %dopar% {
    ...
    for (i in seq)   {
      ...
      if (correct==3) {
        ...
        effects.test1000_2 <- SNCT$EFF1000_TEST[which(SNCT$RULE.NUM==2)]
        effects.test1101_1 <- SNCT$EFF1101_TEST[which(SNCT$RULE.NUM==1)] 
        effects.test1101_2 <- SNCT$EFF1101_TEST[which(SNCT$RULE.NUM==3)]
        se.test1000_1 <- SNCT$SE1000_TEST[which(SNCT$RULE.NUM==1)] 
        se.test1000_2 <- SNCT$SE1000_TEST[which(SNCT$RULE.NUM==2)]
        se.test1101_1 <- SNCT$SE1101_TEST[which(SNCT$RULE.NUM==1)] 
        se.test1101_2 <- SNCT$SE1101_TEST[which(SNCT$RULE.NUM==3)]
      }
      ...
      if (correct==2){ 
        ...
        if (length((which(SNCT$RULE.NUM==1 | SNCT$RULE.NUM==3)))==2){
          ...
          effects.test1000_2 <- 0
          effects.test1101_1 <- SNCT$EFF1101_TEST[which(SNCT$RULE.NUM==1)] 
          effects.test1101_2 <- SNCT$EFF1000_TEST[which(SNCT$RULE.NUM==3)] 
          se.test1000_1 <- SNCT$SE1000_TEST[which(SNCT$RULE.NUM==1)]
          se.test1000_2 <- 0
          se.test1101_1 <- SNCT$SE1101_TEST[which(SNCT$RULE.NUM==1)] 
          se.test1101_2 <- SNCT$SE1101_TEST[which(SNCT$RULE.NUM==3)]
        ...
        if (length((which(SNCT$RULE.NUM==2 | SNCT$RULE.NUM==3)))==2){
          ...
          effects.test1101_2 <- SNCT$EFF1101_TEST[which(SNCT$RULE.NUM==3)]
          se.test1000_1 <- 0
          se.test1000_2 <- SNCT$EFF1000_TEST[which(SNCT$RULE.NUM==2)]
          se.test1101_1 <- 0
          se.test1101_2 <- SNCT$SE1101_TEST[which(SNCT$RULE.NUM==3)]
        }
...
## Create a Matrix for the Results
nctree <- cbind(avg_correct_rules, mse_tau_est_1000, mse_tau_est_1101, bias_tau_est_1000, bias_tau_est_1101, coverage_est_1000, coverage_est_1101,
                mse_tau_test_1000, mse_tau_test_1101, bias_tau_test_1000, bias_tau_test_1101, coverage_test_1000, coverage_test_1101, vi_x1, vi_x2, vi_x3, vi_X)
colnames(nctree) <- c("correct_rules",
                      "mse_tau_est_1000", "mse_tau_est_1101",
                      "bias_tau_est_1000", "bias_tau_est_1101",
                      "coverage_est_1000", "coverage_est_1101",
...
write.csv(nctree, file = "three_main_effects_overlap_1500.csv")
...
for(i in seq){
  mse_tau_est_1101[which(seq==i)] <- mean( (abs(tau_est_1101[,which(seq==i)]) - i*1.50)^2 , na.rm = TRUE )
}

for(i in seq){
  mse_tau_test_1101[which(seq==i)] <- mean( (abs(tau_test_1101[,which(seq==i)]) - i*1.50)^2 , na.rm = TRUE )
}
...
for(i in seq){
  bias_tau_est_1101[which(seq==i)] <- mean( (abs(tau_est_1101[,which(seq==i)]) - i*1.50) , na.rm = TRUE )
}

for(i in seq){
  bias_tau_test_1101[which(seq==i)] <- mean( (abs(tau_test_1101[,which(seq==i)]) - i*1.50) , na.rm = TRUE )
}
...
for(i in seq){
  for(j in 1:nrow(tau_est_1101)) {
    if (is.na(tau_est_1101[j,which(seq==i)])==FALSE) {
      coverage_est_1101[j,which(seq==i)] <- between(i*1.50, abs(tau_est_1101[j,which(seq==i)]) - 1.96*se_tau_est_1101[j,which(seq==i)],
                                                    abs(tau_est_1101[j,which(seq==i)]) + 1.96*se_tau_est_1101[j,which(seq==i)])
    }
    else {
      coverage_est_1101[j,which(seq==i)] <- NA
...
for(i in seq){
  for(j in 1:nrow(tau_test_1101)) {
    if (is.na(tau_test_1101[j,which(seq==i)])==FALSE) {
      coverage_test_1101[j,which(seq==i)] <- between(i*1.50, abs(tau_test_1101[j,which(seq==i)]) - 1.96*se_tau_test_1101[j,which(seq==i)],
                                                     abs(tau_test_1101[j,which(seq==i)]) + 1.96*se_tau_test_1101[j,which(seq==i)])
    }
    else {
      coverage_test_1101[j,which(seq==i)] <- NA
...
colnames(nctree) <- c("correct_rules",
                      ...
                      "coverage_test_1000", "coverage_test_1101",
                      "vi_x1", "vi_x2", "vi_x3", "vi_X")
write.csv(nctree, file = "three_main_effects_overlap_effect_size_1500_50.csv")
...
colnames(nctree) <- c("correct_rules",
                      ...
                      "coverage_test_1000", "coverage_test_1101",
                      "vi_x1", "vi_x2", "vi_X")
write.csv(nctree, file = "two_main_effects_correlated_1500.csv")
