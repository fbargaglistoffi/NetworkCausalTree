...
This package is implemented in R and follows standard R development conventions, ensuring compatibility across systems. The GitHub repository provides detailed vignettes and example scripts to facilitate reproducibility. Community engagement is encouraged through documented contribution guidelines ([`CONTRIBUTING.md`](https://github.com/fbargaglistoffi/NetworkCausalTree/blob/master/CONTRIBUTING.md)) and a code of conduct ([`CODE_OF_CONDUCT.md`](https://github.com/fbargaglistoffi/NetworkCausalTree/blob/master/CODE_OF_CONDUCT.md)). Users can report issues or request support through the GitHub Issues page.
