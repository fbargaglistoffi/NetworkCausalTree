...
$$
\tau_{(w,g;w',g')}(\ell(\vx)) =  \frac{1}{N(\ell(\vx))}\sum_{k=1}^K\sum_{i=1}^{n_k}\Yik(w,g)\mathds{1}(\vXik\in \ell(\vx)) -  \frac{1}{N(\ell(\vx))}\sum_{k=1}^K\sum_{i=1}^{n_k}\Yik(w',g')\mathds{1}(\vXik\in \ell(\vx)). 
$$
